...
export default function UpdateContact(props) {
    ...
    return(
        <>
            <button type="button" onClick={()=>getDetail(props.id)} data-toggle="tooltip" data-placement="top" title="Edit" className="btn btn-success rounded shadow" data-bs-toggle="modal" data-bs-target="#editContact">Update</button>
